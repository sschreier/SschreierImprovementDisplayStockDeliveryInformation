...
namespace Sschreier\ImprovementDisplayStockDeliveryInformation\Storefront\Subscriber;

use Shopware\Core\System\SystemConfig\SystemConfigService;
use Shopware\Storefront\Theme\Event\ThemeCompilerEnrichScssVariablesEvent;
use Symfony\Component\EventDispatcher\EventSubscriberInterface;
use Symfony\Component\Serializer\NameConverter\CamelCaseToSnakeCaseNameConverter;
use Sschreier\ImprovementDisplayStockDeliveryInformation\SschreierImprovementDisplayStockDeliveryInformation;
...
class ThemeVariablesSubscriber implements EventSubscriberInterface
{
    ...
    {
        $configFields = $this->systemConfig->get('SschreierImprovementDisplayStockDeliveryInformation.config', $event->getSalesChannelId());
        ...
        foreach($configFields as $configKey => $value) {
            ...
            if($value && in_array($configKey, SschreierImprovementDisplayStockDeliveryInformation::PLUGIN_CONFIG_VARS)) {
                $event->addVariable(
